...
app_title <- "Data Wrangling Studio A"
...
ga_experiment_variant <- "A_original_layout"
ga_app_version <- "new_project_app_a"
...
(function() {
  var appName = 'Data Wrangling Studio A';
